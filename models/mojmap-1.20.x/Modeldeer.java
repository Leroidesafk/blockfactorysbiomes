...
public class Modeldeer<T extends DeerEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(34, 27).addBox(-2.0F, -9.0F, -7.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(28, 42).addBox(3.0F, -11.0F, 0.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(36, 42).addBox(-6.0F, -11.0F, 0.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 27).addBox(-3.0F, -12.0F, -3.0F, 6.0F, 15.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(34, 34).addBox(-8.0F, -14.0F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(22, 42).addBox(7.0F, -18.0F, -2.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(22, 42).addBox(-8.0F, -18.0F, -2.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(34, 37).addBox(2.0F, -14.0F, -2.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(42, 37).addBox(2.0F, -16.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(34, 34).addBox(4.0F, -14.0F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(34, 37).addBox(-4.0F, -14.0F, -2.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(42, 37).addBox(-3.0F, -16.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -8.5F));
