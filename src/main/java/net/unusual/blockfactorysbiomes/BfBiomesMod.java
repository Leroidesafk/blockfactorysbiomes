...
@Mod("bf_biomes")
public class BfBiomesMod {
	public static final Logger LOGGER = LogManager.getLogger(BfBiomesMod.class);
	public static final String MODID = "bf_biomes";
	...
	public BfBiomesMod() {
		...
		BfBiomesModSounds.REGISTRY.register(bus);
		BfBiomesModBlocks.REGISTRY.register(bus);

		BfBiomesModItems.REGISTRY.register(bus);
