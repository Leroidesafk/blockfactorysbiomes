...
import net.unusual.blockfactorysbiomes.procedures.DriedGrassOnBoneMealSuccessProcedure;
import net.unusual.blockfactorysbiomes.procedures.DriedGrassCanBoneMealBeUsedOnThisBlockProcedure;
...
public class DriedGrassBlock extends FlowerBlock implements BonemealableBlock {
	public DriedGrassBlock() {
	...
	public void performBonemeal(ServerLevel world, RandomSource random, BlockPos pos, BlockState blockstate) {
		DriedGrassOnBoneMealSuccessProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
