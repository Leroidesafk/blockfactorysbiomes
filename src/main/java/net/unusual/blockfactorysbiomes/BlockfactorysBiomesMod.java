...
import net.unusual.blockfactorysbiomes.init.BlockfactorysBiomesModTabs;
import net.unusual.blockfactorysbiomes.init.BlockfactorysBiomesModSounds;
...
@Mod("blockfactorys_biomes")
public class BlockfactorysBiomesMod {
	public static final Logger LOGGER = LogManager.getLogger(BlockfactorysBiomesMod.class);
	public static final String MODID = "blockfactorys_biomes";

	public BlockfactorysBiomesMod() {
		...
		BlockfactorysBiomesModTabs.REGISTRY.register(bus);
