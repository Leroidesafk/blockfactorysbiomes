...
public class CoconutProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public CoconutProjectileEntity(EntityType<? extends CoconutProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public CoconutProjectileEntity(EntityType<? extends CoconutProjectileEntity> type, LivingEntity entity, Level world) {
