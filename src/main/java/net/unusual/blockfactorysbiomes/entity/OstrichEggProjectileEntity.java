...
import net.unusual.blockfactorysbiomes.procedures.OstrichEggProjectileProjectileHitProcedure;
...
public class OstrichEggProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(BfBiomesModItems.OSTRICH_EGG.get());
