...
public class BfBiomesModItems {
	...
	public static final RegistryObject<Item> RAW_DEER_BEEF = REGISTRY.register("raw_deer_beef", () -> new RawDeerBeefItem());
	...
	public static final RegistryObject<Item> OSTRICH_SPAWN_EGG = REGISTRY.register("ostrich_spawn_egg", () -> new ForgeSpawnEggItem(BfBiomesModEntities.OSTRICH, -14672612, -1468021, new Item.Properties()));
	...
	public static final RegistryObject<Item> DEER_HORN = REGISTRY.register("deer_horn", () -> new DeerHornItem());
