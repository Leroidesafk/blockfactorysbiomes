...
public class BfBiomesModBlocks {
	...
	public static final RegistryObject<Block> MAPLE_GRASS = REGISTRY.register("maple_grass", () -> new MapleGrassBlock());
	public static final RegistryObject<Block> TALL_MAPLE_GRASS = REGISTRY.register("tall_maple_grass", () -> new TallMapleGrassBlock());
	public static final RegistryObject<Block> MAPLE_BUSH = REGISTRY.register("maple_bush", () -> new MapleBushBlock());
	public static final RegistryObject<Block> MAPLE_SAPLING = REGISTRY.register("maple_sapling", () -> new MapleSaplingBlock());
	public static final RegistryObject<Block> FALLEN_MAPLE_LOG = REGISTRY.register("fallen_maple_log", () -> new FallenMapleLogBlock());
	public static final RegistryObject<Block> FALLEN_OVERGROWN_MAPLE_LOG = REGISTRY.register("fallen_overgrown_maple_log", () -> new FallenOvergrownMapleLogBlock());
	public static final RegistryObject<Block> MAPLE_LOG_PILE = REGISTRY.register("maple_log_pile", () -> new MapleLogPileBlock());
	public static final RegistryObject<Block> COCONUT_LOG_PILE = REGISTRY.register("coconut_log_pile", () -> new CoconutLogPileBlock());
	...
	public static final RegistryObject<Block> DRIPING_MAPLE_LOG = REGISTRY.register("driping_maple_log", () -> new DripingMapleLogBlock());
	...
	public static final RegistryObject<Block> BAOBAB_BUSH = REGISTRY.register("baobab_bush", () -> new BaobabBushBlock());
